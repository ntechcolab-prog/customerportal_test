...
(function () {
  ...
  style.textContent = [
    ...
    '.hourmeter-edit-btn { width:24px; height:24px; border-radius:6px; display:inline-flex; align-items:center; justify-content:center; background:none; border:1px solid #e5e7eb; cursor:pointer; color:#6b6e73; transition:all 0.15s; flex-shrink:0; }',
    '.hourmeter-edit-btn:hover { background:#f3f4f6; border-color:#d4d6d8; color:#007167; }',
    '.hourmeter-edit-btn svg { width:12px; height:12px; }',
